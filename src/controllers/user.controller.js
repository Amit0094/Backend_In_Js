...
const getUserChannelProfile = asyncHandler(async (req, res) => {
  ...
  const channel = await User.aggregate([
    ...
    },
    {
      $lookup: {
        ...
        as: "subscribedTo", // new field called subscribedTo is added, who containing all channels that user is subscribed
      },
    },
    {
      $addFields: {
    ...
    // The $project stage in a MongoDB aggregation pipeline is used to shape the output documents by including, excluding, or transforming fields. Essentially, it allows you to specify which fields you want to return in the results of your query.
    {
      $project: {
        fullName: 1,
        username: 1,
  ...
  console.log(`Data inside channel :: ${channel}`);
